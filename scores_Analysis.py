...
print("{}% of data of for math lies within 1 standard deviation".format(len(math_score_of_data_within_1_std_deviation)*100.0/len(math_score)))
...
print("{}% of data of for math lies within 2 standard deviation".format(len(math_score_of_data_within_2_std_deviation)*100.0/len(math_score)))
...
print("{}% of data of for math lies within 3 standard deviation".format(len(math_score_of_data_within_3_std_deviation)*100.0/len(math_score)))
...
print("{}% of data of for reading lies within 1 standard deviation".format(len(reading_score_of_data_within_1_std_deviation)*100.0/len(reading_score)))
...
print("{}% of data of for reading lies within 2 standard deviation".format(len(reading_score_of_data_within_2_std_deviation)*100.0/len(reading_score)))
...
print("{}% of data of for reading lies within 3 standard deviation".format(len(reading_score_of_data_within_3_std_deviation)*100.0/len(reading_score)))
...
print("{}% of data of for writing lies within 1 standard deviation".format(
    len(writing_score_of_data_within_1_std_deviation)*100.0/len(writing_score)))
...
print("{}% of data of for writing lies within 2 standard deviation".format(
    len(writing_score_of_data_within_2_std_deviation)*100.0/len(writing_score)))
...
print("{}% of data of for writing lies within 3 standard deviation".format(len(writing_score_of_data_within_3_std_deviation)*100.0/len(writing_score)))
